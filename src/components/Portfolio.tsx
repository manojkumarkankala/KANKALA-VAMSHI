import { Globe as WPIcon, ExternalLink, FolderOpen, Image as ImageIcon, Wrench, ArrowRight, Pencil, PlayCircle } from 'lucide-react';
                  ...
                  <div className="relative flex h-36 items-center justify-center overflow-hidden rounded-xl bg-navy-50">
                    {item.video_url ? (
                      <video
                        ...
                        poster={item.screenshot_url || undefined}
                      />
                    ) : item.screenshot_url ? (
                    ...
                    {item.video_url && (
                      <span className="pointer-events-none absolute left-3 top-3 rounded-md bg-black/70 px-2 py-0.5 text-[10px] font-semibold text-white backdrop-blur-sm">
